...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 130D05D4A1
	for <lists+linux-fscrypt@lfdr.de>; Tue,  2 Jul 2019 18:48:41 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726793AbfGBQsk (ORCPT <rfc822;lists+linux-fscrypt@lfdr.de>);
        Tue, 2 Jul 2019 12:48:40 -0400
Received: from mail-lf1-f66.google.com ([209.85.167.66]:44800 "EHLO
        mail-lf1-f66.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1726308AbfGBQsk (ORCPT
        <rfc822;linux-fscrypt@vger.kernel.org>);
        Tue, 2 Jul 2019 12:48:40 -0400
Received: by mail-lf1-f66.google.com with SMTP id r15so11872624lfm.11
        for <linux-fscrypt@vger.kernel.org>; Tue, 02 Jul 2019 09:48:37 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=linaro.org; s=google;
        h=from:to:cc:subject:date:message-id:in-reply-to:references;
        bh=eXDMSc6+DEIO5qZwvfUHHltfdMHJpXpQAlS/nAp/yYY=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=x-gm-message-state:from:to:cc:subject:date:message-id:in-reply-to
         :references;
        bh=eXDMSc6+DEIO5qZwvfUHHltfdMHJpXpQAlS/nAp/yYY=;
        b=
X-Gm-Message-State: APjAAAWOvh0Xu/pLVpOJoB3VaFJGDoO31Ik6VHW6lnzIYDNSaHXk0e/M
        PcokHNK1v9V+EoRNIJL5fZ9aKhKdZhCdUmkK
X-Google-Smtp-Source: APXvYqyLLNRBfgMsg8FJN5tjwyPOAepatqWZgZS8FX9VNpz9LF2Ylj9rS+NLSM8Kz5uGpx9LHqwL0A==
X-Received: by 2002:ac2:5a5e:: with SMTP id r30mr14841686lfn.12.1562086116292;
        Tue, 02 Jul 2019 09:48:36 -0700 (PDT)
Received: from e111045-lin.arm.com (89-212-78-239.static.t-2.net. [89.212.78.239])
        by smtp.gmail.com with ESMTPSA id r17sm3906055ljc.85.2019.07.02.09.48.34
        (version=TLS1_3 cipher=AEAD-AES256-GCM-SHA384 bits=256/256);
        Tue, 02 Jul 2019 09:48:35 -0700 (PDT)
...
Subject: [PATCH v7 5/7] crypto: essiv - add test vector for essiv(cbc(aes),aes,sha256)
Date:   Tue,  2 Jul 2019 18:48:13 +0200
Message-Id: <20190702164815.6341-6-ard.biesheuvel@linaro.org>
...
index 658a7eeebab2..e2daa3f165c1 100644
--- a/crypto/testmgr.c
+++ b/crypto/testmgr.c
@@ -4253,6 +4253,20 @@ static const struct alg_test_desc alg_test_descs[] = {
 		.suite = {
...
index 1fdae5993bc3..3295ef07512b 100644
--- a/crypto/testmgr.h
+++ b/crypto/testmgr.h
@@ -33575,4 +33575,501 @@ static const struct comp_testvec zstd_decomp_tv_template[] = {
 			  "functions.",
 	},
 };
+
