...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3CF32ADE24
	for <lists+linux-fscrypt@lfdr.de>; Mon,  9 Sep 2019 19:43:56 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730163AbfIIRnz (ORCPT <rfc822;lists+linux-fscrypt@lfdr.de>);
        Mon, 9 Sep 2019 13:43:55 -0400
Received: from mail.kernel.org ([198.145.29.99]:56932 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1729835AbfIIRnz (ORCPT <rfc822;linux-fscrypt@vger.kernel.org>);
        Mon, 9 Sep 2019 13:43:55 -0400
Received: from ebiggers-linuxstation.mtv.corp.google.com (unknown [104.132.1.77])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id 950D321479;
        Mon,  9 Sep 2019 17:43:51 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1568051031;
        bh=nJQ2QsX/hO/qdwvq+OlyhLAM3JwEPISupbA5G6P1hhM=;
        h=From:To:Cc:Subject:Date:From;
        b=hKqmaAhOGgW2jmW6F6NSB1wyVnGiYDgYezRQVpwyIxhwp5jNYqYxXUbNAzvrD6Nnk
         v9HUIyCo+wO7Bv2+TUzrSN3GNNhYUUTzG6AF6p4heR5ZbYxjN4g84wacRmRgvAZWSY
         Ohmkxo3yK0NCK3FTeDBLLJcuF0gG10y7X8HZPmX4=
From:   Eric Biggers <ebiggers@kernel.org>
To:     linux-ext4@vger.kernel.org
Cc:     linux-fscrypt@vger.kernel.org, Andreas Dilger <adilger@dilger.ca>,
        Theodore Ts'o <tytso@mit.edu>
Subject: [PATCH v4] e2fsck: check for consistent encryption policies
Date:   Mon,  9 Sep 2019 10:43:10 -0700
Message-Id: <20190909174310.182019-1-ebiggers@kernel.org>
...
- Other cleanups.
 ...
 18 files changed, 801 insertions(+), 50 deletions(-)
...
index 27c69575..c11f186b 100644
--- a/e2fsck/problem.c
+++ b/e2fsck/problem.c
...
index 5cc89249..2ea0c91d 100644
--- a/e2fsck/problem.h
+++ b/e2fsck/problem.h
