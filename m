...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3D481131EFA
	for <lists+linux-fscrypt@lfdr.de>; Tue,  7 Jan 2020 06:17:57 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727333AbgAGFRR (ORCPT <rfc822;lists+linux-fscrypt@lfdr.de>);
        Tue, 7 Jan 2020 00:17:17 -0500
Received: from mail-ua1-f73.google.com ([209.85.222.73]:45056 "EHLO
        mail-ua1-f73.google.com" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S1727298AbgAGFRD (ORCPT
        <rfc822;linux-fscrypt@vger.kernel.org>);
        Tue, 7 Jan 2020 00:17:03 -0500
Received: by mail-ua1-f73.google.com with SMTP id h10so10793250uab.12
        for <linux-fscrypt@vger.kernel.org>; Mon, 06 Jan 2020 21:17:01 -0800 (PST)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=google.com; s=20161025;
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         :cc;
        bh=+n/l13Z+GFlU0bvuVcJhdSa4yE2vT42q26B9mK/rk3I=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=+n/l13Z+GFlU0bvuVcJhdSa4yE2vT42q26B9mK/rk3I=;
        b=
X-Gm-Message-State: APjAAAWUcofFKzhtLwmiB4tjIUWzLcP+17uNA39eVbyCcn683wALBvAR
        SXQ84jrRiMyVLiB5BM0Ps4gzk9PSbg8=
X-Google-Smtp-Source: APXvYqyTLWrfF9JGDQBq4YWUcaFRuZXOasjvFsExSOqAkXBxQtTQkoF0VPwn8N3RYjOUkSxRFqvYyJvcw60=
X-Received: by 2002:a1f:7cc2:: with SMTP id x185mr60308182vkc.1.1578374220797;
 Mon, 06 Jan 2020 21:17:00 -0800 (PST)
Date:   Mon,  6 Jan 2020 21:16:37 -0800
In-Reply-To: <20200107051638.40893-1-drosen@google.com>
Message-Id: <20200107051638.40893-6-drosen@google.com>
Mime-Version: 1.0
References: <20200107051638.40893-1-drosen@google.com>
X-Mailer: git-send-email 2.24.1.735.g03f4e72817-goog
Subject: [PATCH v2 5/6] ext4: Hande casefolding with encryption
...
---
After the fscrypt changes go in, ext4_ci_compare can have parent made
const again
 ...
 fs/ext4/namei.c                              | 293 +++++++++++++------
 fs/ext4/super.c                              |   6 -
 8 files changed, 345 insertions(+), 145 deletions(-)
...
index f70b3bb57c48c..c63a04dbe1988 100644
--- a/fs/ext4/dir.c
+++ b/fs/ext4/dir.c
@@ -26,10 +26,11 @@
...
index 3162ef2e53d46..f06bab489d372 100644
--- a/fs/ext4/ext4.h
+++ b/fs/ext4/ext4.h
...
index 7f4e625ab2f9b..42ed2e9d3a1f4 100644
--- a/fs/ext4/namei.c
+++ b/fs/ext4/namei.c
