Return-Path: <linux-fscrypt+bounces-1006-lists+linux-fscrypt=lfdr.de@vger.kernel.org>
X-Original-To: lists+linux-fscrypt@lfdr.de
Delivered-To: lists+linux-fscrypt@lfdr.de
Received: from sea.lore.kernel.org (sea.lore.kernel.org [IPv6:2600:3c0a:e001:db::12fc:5321])
	by mail.lfdr.de (Postfix) with ESMTPS id 7E9A1CB34EC
	for <lists+linux-fscrypt@lfdr.de>; Wed, 10 Dec 2025 16:27:51 +0100 (CET)
Received: from smtp.subspace.kernel.org (conduit.subspace.kernel.org [100.90.174.1])
	by sea.lore.kernel.org (Postfix) with ESMTP id CEF89316532A
	for <lists+linux-fscrypt@lfdr.de>; Wed, 10 Dec 2025 15:24:11 +0000 (UTC)
Received: from localhost.localdomain (localhost.localdomain [127.0.0.1])
	by smtp.subspace.kernel.org (Postfix) with ESMTP id AE6BE324B32;
	Wed, 10 Dec 2025 15:24:11 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org;
	dkim=pass (2048-bit key) header.d=infradead.org header.i=@infradead.org header.b="2GCrPcMt"
X-Original-To: linux-fscrypt@vger.kernel.org
Received: from bombadil.infradead.org (bombadil.infradead.org [198.137.202.133])
	(using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
	(No client certificate requested)
	by smtp.subspace.kernel.org (Postfix) with ESMTPS id B274A302770;
	Wed, 10 Dec 2025 15:24:09 +0000 (UTC)
Authentication-Results: smtp.subspace.kernel.org; arc=none smtp.client-ip=198.137.202.133
ARC-Seal:i=1; a=rsa-sha256; d=subspace.kernel.org; s=arc-20240116;
	t=1765380251; cv=none; b=Xy1hitV494u1lNuJxVJwLbWFVqYYiDWDefcJojzbrj3gye/MoieBos8RvMH54boTsxM3wuwiioXlNLzhEnIQ2ExOaB1YiNljIero2S0dnpDEOS1l+mHziPpzvNKjhyS19wSnxMHdM6Ea0+WR3TdWW3QaeV4cGXP3J0aiwRucc70=
ARC-Message-Signature:i=1; a=rsa-sha256; d=subspace.kernel.org;
	s=arc-20240116; t=1765380251; c=relaxed/simple;
	bh=8OZk7b/N6Wa0E8YQRi+yYxrvzq3nYyf7JVIDQtiGnhM=;
	h=From:To:Cc:Subject:Date:Message-ID:In-Reply-To:References:
	 MIME-Version; b=p4bBNDAnGhVc9Ubm8DHJY0ySL12bpHJWMBSsNh5jExgSLCQ+oFvc8IiI7Dx9jVJ6jLryjBPXPpGtCZ4JQL30WMThm5UQZEtmxIZE3IFZClOhRGd0u/p2v89bCP60SkZGca9+FxYGM+s6m1SyoMnNlBOEaqeQr0CI9ofunxHLBn4=
ARC-Authentication-Results:i=1; smtp.subspace.kernel.org; dmarc=fail (p=none dis=none) header.from=lst.de; spf=none smtp.mailfrom=bombadil.srs.infradead.org; dkim=pass (2048-bit key) header.d=infradead.org header.i=@infradead.org header.b=2GCrPcMt; arc=none smtp.client-ip=198.137.202.133
...
DKIM-Signature: v=1; a=rsa-sha256; q=dns/txt; c=relaxed/relaxed;
	...
	bh=dt+mi8+o5X+nRnsnK4S2Vtt+h+3gvjuvcBZSGprsIQI=; b=2GCrPcMtJW1qzJqgNb1/lUK5SU
	;
Received: from 2a02-8389-2341-5b80-d601-7564-c2e0-491c.cable.dynamic.v6.surfer.at ([2a02:8389:2341:5b80:d601:7564:c2e0:491c] helo=localhost)
	by bombadil.infradead.org with esmtpsa (Exim 4.98.2 #2 (Red Hat Linux))
	id 1vTM2y-0000000FZ2g-3RsS;
	Wed, 10 Dec 2025 15:24:09 +0000
...
Date: Wed, 10 Dec 2025 16:23:35 +0100
Message-ID: <20251210152343.3666103-7-hch@lst.de>
...
index 591f5439de9e..d2b9fb8273a9 100644
...
@@ -604,7 +583,8 @@ int blk_crypto_fallback_start_using_mode(enum blk_crypto_mode_num mode_num)
...
+				0, 0);
 		if (IS_ERR(slotp->tfms[mode_num])) {
 			...
 			if (err == -ENOENT) {
@@ -616,7 +596,7 @@ int blk_crypto_fallback_start_using_mode(enum blk_crypto_mode_num mode_num)
 			goto out_free_tfms;
 		}
...
@@ -630,7 +610,7 @@ int blk_crypto_fallback_start_using_mode(enum blk_crypto_mode_num mode_num)
 out_free_tfms:
 	for (i = 0; i < blk_crypto_num_keyslots; i++) {
 		slotp = &blk_crypto_keyslots[i];
