...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 6962F61A5F2
	for <lists+linux-fscrypt@lfdr.de>; Sat,  5 Nov 2022 00:40:03 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S229629AbiKDXkC (ORCPT <rfc822;lists+linux-fscrypt@lfdr.de>);
        Fri, 4 Nov 2022 19:40:02 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:59570 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S229548AbiKDXkB (ORCPT
        <rfc822;linux-fscrypt@vger.kernel.org>);
        Fri, 4 Nov 2022 19:40:01 -0400
Received: from dfw.source.kernel.org (dfw.source.kernel.org [139.178.84.217])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 073C027B38;
        Fri,  4 Nov 2022 16:39:58 -0700 (PDT)
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        (using TLSv1.2 with cipher ECDHE-RSA-AES256-GCM-SHA384 (256/256 bits))
        (No client certificate requested)
        by dfw.source.kernel.org (Postfix) with ESMTPS id 734A962390;
        Fri,  4 Nov 2022 23:39:57 +0000 (UTC)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id BA695C433D7;
        Fri,  4 Nov 2022 23:39:56 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1667605196;
        bh=nzCc5pj8fgkcW8ef38F7zUtT+OCK44rdLnlOGgcqyus=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
From:   Eric Biggers <ebiggers@kernel.org>
To:     stable@vger.kernel.org
Cc:     linux-fscrypt@vger.kernel.org
Subject: [PATCH 5.10 2/3] fscrypt: stop using keyrings subsystem for fscrypt_master_key
...
index 8a0141f7195bf..b746d7df37582 100644
...
index 0c6fa5c2d6f3a..8268206ef21e5 100644
--- a/fs/crypto/hooks.c
+++ b/fs/crypto/hooks.c
@@ -5,8 +5,6 @@
...
index 0b3ffbb4faf4a..175b071beaf81 100644
...
index 72aec33e0ea5d..7b14054fab494 100644
...
index bae3fe80f852e..beee3e1b4c296 100644
--- a/fs/super.c
+++ b/fs/super.c
...
index d0a1b8edfd9db..23d3ea47f7649 100644
