...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C633F9B470
	for <lists+linux-fscrypt@lfdr.de>; Fri, 23 Aug 2019 18:24:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S2436711AbfHWQYn (ORCPT <rfc822;lists+linux-fscrypt@lfdr.de>);
        Fri, 23 Aug 2019 12:24:43 -0400
Received: from mail.kernel.org ([198.145.29.99]:41006 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S2436712AbfHWQYm (ORCPT <rfc822;linux-fscrypt@vger.kernel.org>);
        Fri, 23 Aug 2019 12:24:42 -0400
Received: from ebiggers-linuxstation.mtv.corp.google.com (unknown [104.132.1.77])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id ED41E21726;
        Fri, 23 Aug 2019 16:24:36 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1566577477;
        bh=T8ywSQK9pAzJnJ1YzaDF31OY7/accfxVwPwr61evenA=;
        h=From:To:Cc:Subject:Date:From;
        b=1i5i3N+FHclhi70x+7S54zCeL9rK+RWR3dUmtcjP/9RF0h5Z9T9f6K8f7RjvLtyWC
         WTZ47sraUweM0A9B5O6TvHnZClFeNQG7jritfJDqdS1pGZkt91MwvwCYbB6ONAObAi
         1/n5RX4snVfFI4BX3v8ygXXRx8RLHePggscJo9bc=
From:   Eric Biggers <ebiggers@kernel.org>
To:     linux-ext4@vger.kernel.org
Cc:     linux-fscrypt@vger.kernel.org
Subject: [PATCH v3] e2fsck: check for consistent encryption policies
Date:   Fri, 23 Aug 2019 09:23:39 -0700
Message-Id: <20190823162339.186643-1-ebiggers@kernel.org>
...
index 41eac088..e6365406 100644
--- a/e2fsck/pass1.c
+++ b/e2fsck/pass1.c
@@ -27,6 +27,7 @@
...
index 4863ea7a..c8f717b7 100644
--- a/e2fsck/problem.c
+++ b/e2fsck/problem.c
@@ -1246,6 +1246,16 @@ static struct e2fsck_problem problem_table[] = {
...
@@ -1772,6 +1782,16 @@ static struct e2fsck_problem problem_table[] = {
...
index 67a9f952..4ba632a0 100644
--- a/e2fsck/problem.h
+++ b/e2fsck/problem.h
@@ -696,6 +696,11 @@ struct problem_context {
 /* Offer to clear uninitialized flag on an extent */
 #define PR_1_CLEAR_UNINIT_EXTENT		0x010087
 
+/* Inode has encrypt flag but no encryption extended attribute */
+#define PR_1_MISSING_ENCRYPTION_XATTR		0x010088
+
+/* Encrypted inode has corrupt encryption extended attribute */
+#define PR_1_CORRUPT_ENCRYPTION_XATTR		0x010089
 
 /*
  * Pass 1b errors
@@ -1012,6 +1017,12 @@ struct problem_context {
