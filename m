...
Received: from out1.vger.email (out1.vger.email [IPv6:2620:137:e000::1:20])
	by mail.lfdr.de (Postfix) with ESMTP id 621C57E1135
	for <lists+linux-fscrypt@lfdr.de>; Sat,  4 Nov 2023 22:17:14 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S230443AbjKDVRP (ORCPT <rfc822;lists+linux-fscrypt@lfdr.de>);
        Sat, 4 Nov 2023 17:17:15 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:46170 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S230330AbjKDVRO (ORCPT
        <rfc822;linux-fscrypt@vger.kernel.org>);
        Sat, 4 Nov 2023 17:17:14 -0400
Received: from smtp.kernel.org (relay.kernel.org [52.25.139.140])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 9A301123;
        Sat,  4 Nov 2023 14:17:09 -0700 (PDT)
Received: by smtp.kernel.org (Postfix) with ESMTPSA id F048FC433D9;
        Sat,  4 Nov 2023 21:17:08 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=k20201202; t=1699132629;
        bh=4VXF1vwT1I72NW6Ayw/79rkx9ju0YknqguvoPNxCLTE=;
        h=From:To:Cc:Subject:Date:In-Reply-To:References:From;
        b=
...
Subject: [RFC PATCH v8 3/4] blk-crypto: add ioctls to create and prepare hardware-wrapped keys
Date:   Sat,  4 Nov 2023 14:12:58 -0700
Message-ID: <20231104211259.17448-4-ebiggers@kernel.org>
...
@@ -479,20 +479,52 @@ keys, when hardware support is available.  This works in the following way:
...
index 4ea5b837399a..27d431f0e4b9 100644
--- a/Documentation/userspace-api/ioctl/ioctl-number.rst
+++ b/Documentation/userspace-api/ioctl/ioctl-number.rst
@@ -75,22 +75,22 @@ Code  Seq#    Include File                                           Comments
...
@@ -76,20 +76,23 @@ blk_status_t blk_crypto_get_keyslot(struct blk_crypto_profile *profile,
...
@@ -123,20 +126,26 @@ static inline void blk_crypto_rq_set_defaults(struct request *rq) { }
...
@@ -495,20 +495,77 @@ int blk_crypto_derive_sw_secret(struct block_device *bdev,
 		return -EOPNOTSUPP;
...
index 4160f4e6bd5b..a895d8547dd4 100644
--- a/block/ioctl.c
+++ b/block/ioctl.c
@@ -5,20 +5,21 @@
...
+#include "blk-crypto-internal.h"
 			  ...
 			  struct blkpg_partition __user *upart, int op)
 {
 	...
 	if (disk->flags & GENHD_FL_NO_PART)
 		return -EINVAL;
@@ -553,20 +554,24 @@ static int blkdev_common_ioctl(struct block_device *bdev, blk_mode_t mode,
 	case BLKRRPART:
...
+			   u8 eph_key[BLK_CRYPTO_MAX_HW_WRAPPED_KEY_SIZE]);
  ...
  */
@@ -156,20 +198,31 @@ int blk_crypto_profile_init(struct blk_crypto_profile *profile,
...
index da43810b7485..d22f9518059e 100644
